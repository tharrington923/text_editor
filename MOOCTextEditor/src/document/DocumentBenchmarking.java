...
public class DocumentBenchmarking {
	...
	public static void main(String [] args) {
				...
				numToCheck += increment)
		{
			...
			BasicDocument basicDoc = new BasicDocument(textString);
			basicDoc.getFleschScore();
			long tStop = System.nanoTime();
			long tdiff1 = tStop-tStart;
			tStart = System.nanoTime();
			EfficientDocument effDoc = new EfficientDocument(textString);
			effDoc.getFleschScore();
			tStop = System.nanoTime();
			System.out.println(numToCheck + "\t" + tdiff1/1000000000. + "\t"+(tStop-tStart)/1000000000. + "\n");
		}
